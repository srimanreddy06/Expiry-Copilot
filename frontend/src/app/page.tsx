...
export default function Home() {
  ...
  // --- 1. RENDER AUTHENTICATION OR LANDING PANEL ---
  if (!token) {
    if (!showLogin) {
      return (
        <div className="min-h-screen bg-[#09090B] relative flex flex-col overflow-hidden text-zinc-100 font-sans selection:bg-teal-500 selection:text-zinc-950">
          {/* FloatingLines Background */}
          <div className="absolute inset-0 z-0 opacity-70">
            <FloatingLines
              linesGradient={['#14B8A6', '#06B6D4', '#3B82F6', '#6366F1', '#8B5CF6']}
          ...
          <div className="absolute top-[-20%] left-[-10%] w-[600px] h-[600px] rounded-full bg-teal-500/5 blur-[150px] pointer-events-none" />
          <div className="absolute bottom-[-10%] right-[-10%] w-[600px] h-[600px] rounded-full bg-purple-500/5 blur-[150px] pointer-events-none" />

          {/* Navigation Bar */}
          <header className="relative z-10 flex items-center justify-between px-6 md:px-12 py-6 border-b border-zinc-800/40 backdrop-blur-md bg-[#09090B]/30">
